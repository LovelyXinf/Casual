...
if (!function_exists('seo_tags')) {
    function seo_tags($tags = 'title')
    {
        ...
        if (substr($controller, 0, 6) == 'admin_') {
            ...
            $controller = 'admin';
        /* <custom_R> */
        } elseif (substr($controller, 0, 9) == 'operator_') {
            $module_gid = strtolower(substr($controller, 9));
            $controller = 'operator';
        /* </custom_R> */
        } else {
...
if (!function_exists('rewrite_link')) {
    function rewrite_link($module, $method, $data = [], $is_admin = false)
    {
        $CI = &get_instance();
...
if (!function_exists('seolink')) {
    function seolink($module, $method, $data = null)
    {
