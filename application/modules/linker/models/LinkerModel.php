...
class LinkerModel extends \Model
{
     ...
     * @param integer $link_2
     */
    public function getLinksSimpleCountGroup($type_gid, $link_ids = array(), $link_type = 1)
    {
        $type = $this->get_linker_type_by_gid($type_gid);
        if (!$type) {
            return false;
     ...
     * @param array  $links_2
     */
    public function getLinksSimpleArrCount($type_gid, $links_1 = array(), $links_2 = array())
    {
        $type = $this->get_linker_type_by_gid($type_gid);
        if (!$type) {
            return false;
