...
class FieldEditorModel extends \Model
{
    ...
    public function __construct()
    {
        ...
        // TODO: cache
        $this->ci->cache->registerService('field_editor_fields', CacheManager::PROVIDER_REDIS);
    }
    ...
    public function getFormFieldsList($content, $params = [], $filter_object_ids = null, $order_by = [], $lang_id = '')
    {
        ...
        foreach ($fields as $key => $field) {
            /* <custom_R> */
            $value        = isset($content[$field["field_name"]]) ? $content[$field["field_name"]] : null;
            $fields[$key] = $this->fields->{$field["field_type"]}->format_form_fields($field, $value);
            /* </custom_R> */
        }
