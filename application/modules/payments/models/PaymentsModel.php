...
class PaymentsModel extends \Model
{
    ...
    public function getPaymentList($page = null, $items_on_page = null, $order_by = null, $params = array(), $filter_object_ids = null)
    {        
    ...
    public function formatPayments($data)
    {
        ...
        if (!empty($user_ids)) {
            ...
            $users = $this->ci->Users_model->getUsersListByKey(null, null, null, array(), $user_ids);
        }
        ...
        foreach ($data as $key => $payment) {if (!empty($users[$payment["id_user"]])) {
    ...
    public function getPaymentCount($params = array(), $filter_object_ids = null)
    {
    ...
    public function getPaymentTypeList($params = array(), $filter_object_ids = null, $order_by = null)
    {
    ...
    public function getPaymentTypeCount($params = array(), $filter_object_ids = null)
    {
    ...
    public function changePaymentStatus($id_payment, $status)
    {
       ...
       // if ($payment_data["status"] != $status) {
        if (($payment_data["status"] != $status)
            ...
            $this->savePayment($id_payment, array("status" => $status));
    ...
    {       
        ...
        if ($this->ci->pg_module->is_module_installed('services')) {  
            ...
            $services = $this->ci->Services_model->getServiceList(array('where' => array('status' => 1)), null, null);
