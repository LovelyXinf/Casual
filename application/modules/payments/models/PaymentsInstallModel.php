...
class PaymentsInstallModel extends \Model
{
    ...
    private $moderators_methods = array(
        array('module' => 'payments', 'method' => 'paymentsList', 'is_default' => 1, 'group_id' => 5, 'is_hidden' => 0, 'parent_module' => ''),
        array('module' => 'payments', 'method' => 'systems', 'is_default' => 0, 'group_id' => 5, 'is_hidden' => 0, 'parent_module' => ''),
        array('module' => 'payments', 'method' => 'settings', 'is_default' => 0, 'group_id' => 5, 'is_hidden' => 0, 'parent_module' => ''),
    );
    ...
    private $notifications = array(
        "templates" => array(
            array('module' => PaymentsModel::MODULE_GID, "gid" => "payment_status_updated", "name" => "Payment status updated", "vars" => array("user", "payment", "status"), "content_type" => "text"),
        ),
        "notifications" => array(
            array('module' => PaymentsModel::MODULE_GID, "gid" => "payment_status_updated", "template" => "payment_status_updated", "send_type" => "simple"),
        ),
    );
    ...
    public function __construct()
    {
        ...
        $this->demo_content = Setup::getModuleData(
                PaymentsModel::MODULE_GID, Setup::TYPE_DEMO_CONTENT
        );
    }
