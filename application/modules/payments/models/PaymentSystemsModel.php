...
class PaymentSystemsModel extends \Model
{
    ...
    public function getSystemList($params = array(), $filter_object_ids = null, $order_by = null)
    {
    ...
    public function getActiveSystemList($order_by = array("name" => "ASC"))
    {
    ...
    public function getSystemCount($params = array(), $filter_object_ids = null)
    {
     ...
     * @return array
     */
    public function validateTarifsData(array $data = array())
    {
        $return = array('errors' => array(), 'data' => array());
    ...
    public function logData($system_gid, $log_type = "request", $log_data = array())
    {
     ...
     * @return boolean
     */
    public function uploadLogo($system_gid, $size = array('width' => 100, 'height' => 100), $field_name = 'logo')
    {
