...
class SenderModel extends \Model
{
    ...
    {
        $this->ci->db->select('id, email, subject, message, content_type, send_counter')->from(NF_SENDER_TABLE)->order_by('id')->limit($count, 0);
    ...
    public function getSendersList($page = null, $items_on_page = null, $order_by = null, $params = array(), $filter_object_ids = null)
    {
    ...
    public function getSendersCount($params = array(), $filter_object_ids = null)
    {
    ...
    public function send($id = 0)
    {
        ...
        $this->ci->db->select('id, email, subject, message, content_type, send_counter')->from(NF_SENDER_TABLE)->order_by('id');
        $letters = $this->ci->db->get()->result_array();
