...
class BannersInstallModel extends \Model
{
    ...
    protected $notifications = array(
        "templates" => array(
            array("module" => BannersModel::MODULE_GID, "gid" => "banner_need_moderate", "name" => "New banner awaiting moderation", "vars" => array(), "content_type" => "text"),
            array("module" => BannersModel::MODULE_GID, "gid" => "banner_status_approved", "name" => "Banner approved", "vars" => array("user", "banner"), "content_type" => "text"),
            array("module" => BannersModel::MODULE_GID, "gid" => "banner_status_declined", "name" => "Banner declined", "vars" => array("user", "banner"), "content_type" => "text"),
            array("module" => BannersModel::MODULE_GID, "gid" => "banner_status_expired", "name" => "Banner status expired", "vars" => array("user", "banner"), "content_type" => "text"),
        ),
        "notifications" => array(
            array("module" => BannersModel::MODULE_GID, "gid" => "banner_need_moderate", "template" => "banner_need_moderate", "send_type" => "simple"),
            array("module" => BannersModel::MODULE_GID, "gid" => "banner_status_approved", "template" => "banner_status_approved", "send_type" => "simple"),
            array("module" => BannersModel::MODULE_GID, "gid" => "banner_status_declined", "template" => "banner_status_declined", "send_type" => "simple"),
            array("module" => BannersModel::MODULE_GID, "gid" => "banner_status_expired", "template" => "banner_status_expired", "send_type" => "simple"),
        ),
    );
    ...
    protected $moderators_methods = array(
        array('module' => 'banners', 'method' => 'index', 'is_default' => 1, 'group_id' => 1, 'is_hidden' => 0, 'parent_module' => '')
    );
