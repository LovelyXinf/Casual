...
class BannerGroupModel extends \Model
{
    ...
    public function __construct()
    {
        ...
        // TODO: cache
        $this->ci->cache->registerService('banners_groups', CacheManager::PROVIDER_REDIS);
        $this->ci->cache->registerService('banners_pages', CacheManager::PROVIDER_REDIS);
    }
    ...
    public function getAllGroups()
    {
        ...
        if ($this->groups_all === null) {
            ...
            $this->groups_all = $this->ci->cache->get('banners_groups', 'all', function () use ($fields)
            {
                $ci = &get_instance();
    ...
    public function delete($id = null)
    {
        ...
        // TODO: cache
        $this->ci->cache->flush('banners_groups');
    ...
    private function getAllPages()
    {
        if ($this->pages_all === null) {
            ...
            $this->pages_all = $this->ci->cache->get('banners_pages', 'all', function () use ($fields)
            {
                $ci = &get_instance();
    ...
    public function deletePage($group_id, $link)
    {
        ...
        // TODO: cache
        $this->ci->cache->flush('banners_pages');
