 ...
 * @author 		Pilot Group Ltd <http://www.pilotgroup.net/>
 */
class ApiBanners extends \Controller
{
     ...
     */
    /**
    * @api {post} /banners/go Go to banner link
    * @apiGroup Banners
    * @apiParam {int} banner_id Banner id
    */
    public function go()
    {
     ...
     */
    /**
    * @api {post} /banners/my List of my banners
    * @apiGroup Banners
    */
    public function my()
    {
     ...
     */
    /**
    * @api {post} /banners/get_places  Get available banners places
    * @apiGroup Banners
    */
     ...
     * @param string  $alt_text        alternative text value
     * @param string  $expiration_date expiration date
     *
     * @return void
     */
    /**
    * @api {post} /banners/save  Save banner data
    * @apiGroup Banners
    * @apiParam {string} name            banner name
    * @apiParam {int} banner_place_id place identifier
    * @apiParam {string} link            link value
    * @apiParam {string} alt_text        alternative text value
    * @apiParam {string} expiration_date expiration date
    */
     ...
     *
     * @param integer $banner_id     banner identifier
     * @param array   $used_position choose positions
     *
     * @return void
     */
    /**
    * @api {post} /banners/activate  Activate banner
    * @apiGroup Banners
    * @apiParam {int} banner_id       banner id
    * @apiParam {array} used_position choose positions
    */
     ...
     */
    /**
    * @api {post} /banners/delete  Delete banner
    * @apiGroup Banners
    * @apiParam {int} banner_id  Banner id
    */
     ...
     *
     * @param integer $banner_id banner identifier
     * @param boolean $update    if set to true, that will update statistics
     ...
     */
     /**
    * @api {post} /banners/statistic Banner statistics
    * @apiGroup Banners
    * @apiParam {int} banner_id     banner id
    * @apiParam {boolean} update    if set to true, that will update statistics
    * @apiParam {int} year      year value
    * @apiParam {int} month     month value
    * @apiParam {int} day       day value
    */
    ...
    /**
     * Update banners statistics
     *
     * @return void
     */
     /**
    * @api {post} /banners/update_statistic Update banners statistics
    * @apiGroup Banners
    */
