...
class WidgetsModel extends \Model
{
     ...
     * @return array
     */
    private function getWidgetsListInternal($page = null, $limits = null, $order_by = null, $params = array(), $formatted = true)
    {
        $this->ci->db->select(implode(', ', $this->_fields));
        $this->ci->db->from(WIDGETS_TABLE);
     ...
     * @param boolean $formatted     results formatting
     */
    public function getWidgetsList($filters = array(), $page = null, $items_on_page = null, $order_by = null, $formatted = true)
    {
     ...
     * @return array
     */
    public function getWidgetsCount($filters = array())
    {
        $params = $this->getSearchCriteria($filters);
