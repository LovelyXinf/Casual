...
class NewsModel extends \Model
{
    ...
    public function getNewsById($id, $lang_ids = null)
    {
        ...
        $result = $this->ci->db->select(implode(", ", $fields_news))
     ...
     * @return array
     */
    public function getNewsList($page = null, $items_on_page = null, $order_by = null, $params = array(), $filter_object_ids = null, $formated = true)
    {
        $lang_id = $this->ci->pg_language->current_lang_id;
     ...
     * @return integer
     */
    public function getNewsCount($params = array(), $filter_object_ids = null)
    {
    ...
    public function uploadLogoUrl($news_id, $image_link)
    {
        ...
        $this->saveNews($news_id, array('img' => $data["file"]), null, null);
    }
     ...
     * @return string
     */
    public function dynamicBlockGetNews($params, $view, $width = 100)
    {
        $data['params'] = $params;
        $data['view'] = $view;
        $data['width'] = $width;
        $count = $params['count'] ? $params['count'] : 1;
        $attrs['where']['id_lang'] = $this->ci->pg_language->current_lang_id;
    ...
    public function __call($name, $args)
    {
        $methods = [
            ...
            '_dynamic_block_get_news' => 'dynamicBlockGetNews',
