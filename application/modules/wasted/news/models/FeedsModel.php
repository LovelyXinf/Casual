...
class FeedsModel extends \Model
{
     ...
     * @return array
     */
    public function getFeedsList($page = null, $items_on_page = null, $order_by = null, $params = array(), $filter_object_ids = null)
    {
     ...
     * @return integer
     */
    public function getFeedsCount($params = array(), $filter_object_ids = null)
    {
