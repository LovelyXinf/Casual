 ...
 */
class BlacklistCallbacksModel extends \Model
{
    ...
    public function addCallback($module, $model, $method, $event_status = '')
    {
        ...
        $this->ci->db->insert(BLACKLIST_CALLBACKS_TABLE, $attrs);
    ...
    {
        $this->ci->db->where('module', $module)->delete(BLACKLIST_CALLBACKS_TABLE);
    ...
    {
        $this->ci->db->where('id', $id)->delete(BLACKLIST_CALLBACKS_TABLE);
    ...
    public function getCallbacks($event_status = '', $module = '')
    {
        ...
        $result = $this->ci->db->select($this->fields_str)->from(BLACKLIST_CALLBACKS_TABLE)->get()->result_array();
