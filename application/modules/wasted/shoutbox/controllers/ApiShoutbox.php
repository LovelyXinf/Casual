 ...
 **/
class ApiShoutbox extends \Controller
{
    /**
     * Controller
     */
    ...
    /**
    * @api {post} /shoutbox/get Get messages
    * @apiGroup Shoutbox
    * @apiParam {int} [max_id] from max message id 
    * @apiParam {int} [min_id] to min message id
    */
    public function get()
    {
    ...
    /**
    * @api {post} /shoutbox/add Add message
    * @apiGroup Shoutbox
