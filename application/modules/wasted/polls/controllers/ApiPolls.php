 ...
 **/
class ApiPolls extends \Controller
{
    ...
    /**
    * @api {post} /polls/poll Returns poll data
    * @apiGroup Polls
    * @apiParam {int} poll_id poll id
    */
    ...
    /**
    * @api {post} /polls/saveResult Saves poll answer
    * @apiGroup Polls
    * @apiParam {int} poll_id poll id
    * @apiParam {int} answer_id answer id
    ...
    */
    ...
    /**
    * @api {post} /polls/pollsList Polls list
    * @apiGroup Polls
    */
