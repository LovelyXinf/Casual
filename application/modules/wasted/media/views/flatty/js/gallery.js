function gallery(optionArr) {
    ...
    this.init_objects = function () {
        ...
        $('#' + _self.properties.id)
                ...
                .append('<div class="mt20 button-cont hide"><input class="btn btn-cancel form-control" type="button" value="' + _self.properties.button_title + '" /></div>')
    ...
    this.loadLines = function (params, force, is_new) {
        ...
        var post_data = $.extend({icons: lines_images, loaded_count: _p.loaded_count, line_data: _self.properties.line_data, current_page: _self.properties.page.current}, params);
            ...
            success: function (resp) {
                if (resp.errors) {
                    ...
                    if (resp.gallery.media_count && resp.gallery.media) {
                        ...
                        if (typeof ($('[data-page="'+_self.properties.page.current+'"]').offset()) !== 'undefined') {
