...
namespace Pg\modules\ausers\helpers {
    ...
    if (!function_exists('mediaAddPhoto')) {
        function mediaAddPhoto(array $params = array())
        {
            $ci = &get_instance();
...
namespace {
    ...
    if (!function_exists('media_block')) {
        ...
        {
            return Pg\modules\ausers\helpers\mediaBlock($params);
        }
    }
    ...
    if (!function_exists('media_carousel')) {
        ...
        {
            return Pg\modules\ausers\helpers\mediaCarousel($params);
        }
    }
    ...
    if (!function_exists('user_media_block')) {
        ...
        {
            return Pg\modules\ausers\helpers\userMediaBlock($params);
        }
    }
    ...
    if (!function_exists('events_media_block')) {
        ...
        {
            return Pg\modules\ausers\helpers\eventsMediaBlock($params);
        }
    }
    ...
    if (!function_exists('recent_media_block')) {
        ...
        {
            return Pg\modules\ausers\helpers\recentMediaBlock($params);
        }
    }
    ...
    if (!function_exists('get_albums_for_media')) {
        ...
        {
            return Pg\modules\ausers\helpers\getAlbumsForMedia($params);
        }
    }
    ...
    if (!function_exists('media_add_photo')) {
        ...
        {
            return Pg\modules\ausers\helpers\mediaAddPhoto($params);
        }
    }
    if (!function_exists('load_picture')) {
        function load_picture($params)
        {
            return Pg\modules\ausers\helpers\loadPicture($params);
        }
    }
