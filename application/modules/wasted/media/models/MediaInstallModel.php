...
class MediaInstallModel extends \Model
{
    ...
    protected $menu = array(
        ...
        'media_menu_item' => array(
            ...
            'items'  => array(
                'avatar_list_item'   => array('action' => 'create', 'link' => 'admin/media/index/avatar', 'status' => 1, 'sorter' => 1),
                'photo_list_item'    => array('action' => 'create', 'link' => 'admin/media/index', 'status' => 1, 'sorter' => 2),
                'video_list_item'    => array('action' => 'create', 'link' => 'admin/media/index/video', 'status' => 1, 'sorter' => 3),
        ...
        'user_footer_menu' => array(
            ...
            'items'  => array(
                'footer-menu-links-item' => array(
                    'action' => 'none',
                    'items'  => array(
                        'footer-menu-media_gallery-item' => array('action' => 'create', 'link' => 'media/all',  'status' => 1, 'sorter' => 2),
                    ),
                ),
            ),
        ),
    ...
    protected $pages = array("index", "all", "photo", "video", "albums", "audio");
    ...
    private $moderators_methods = array(
        array('module' => 'media', 'method' => 'index', 'is_default' => 1, 'group_id' => 1, 'is_hidden' => 0, 'parent_module' => '')
    );
    /**
     * Constructor
     *
    ...
    public function __construct()
    {
        ...
        $this->access_permissions = Setup::getModuleData(
                MediaModel::MODULE_GID, Setup::TYPE_ACCESS_PERMISSIONS
        );
    }
