...
class PgVideochat extends ChatAbstract
{
    ...
    public function lastChats($page = 1, $params = array(), $admin_mode = true, $subpage = 'outbox')
    {
        $last_chats = array();
    ...
    public function getLastChatsList($page = null, $items_on_page = null, $order_by = null, $params = array(), $filter_object_ids = array())
    {
        $this->ci->db->select();
        $this->ci->db->from(PG_VIDEOCHAT_TABLE);
    ...
    public function getLastChatsCount($params = array(), $filter_object_ids = null)
    {
    ...
    public function saveChat($id_chat = null, $attrs = array())
    {
        if (is_null($id_chat)) {
    ...
    public function canceledChats()
    {
        ...
        $this->ci->db->update(PG_VIDEOCHAT_TABLE, array('status' => 'canceled'));
    ...
    public function getMessagesList($page = null, $items_on_page = null, $order_by = null, $params = array(), $filter_object_ids = array())
    {
        $this->ci->db->select();
    ...
    public function getMessagesCount($params = array(), $filter_object_ids = null)
    {
        if (isset($params["where"]) && is_array($params["where"])) {
            foreach ($params["where"] as $field => $value) {
                $this->ci->db->where($field, $value);
    ...
    public function addMessage($attrs = array())
    {
