...
class ApiChats extends \Controller
{
    ...
    */
    ...
    {   
        ...
        $this->view->assign('data', array('id_chat' => $id_chat));
    ...
    */
    public function getChat($id_chat = null)
    {
        ...
        $chat = $this->active->getLastChatsList(0, 1, null, array('where' => $data), array());
        
        $this->view->assign('data', array('chat' => $chat[0]));
    ...
    */
    public function getChatsList()
    {
        ...
        $this->view->assign('data', array('chats' => $chats));
    ...
    */
    public function getHistory()
    {
        ...
        $data['where_sql'] = array("(invited_user_id = '$user_id' OR invite_user_id = '$user_id')");
        ...
        $chats = $this->active->get_last_chats_list(null, null, $order_by, $data, array());
