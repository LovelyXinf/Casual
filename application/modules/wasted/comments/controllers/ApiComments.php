...
class ApiComments extends \Controller
{
     ...
     */
    /**
    * @api {post} /comments/get  Get comments
    * @apiGroup Comments
    * @apiParam {string} gid  gid comments
    * @apiParam {int} id_obj  id object
    * @apiParam {int} page  page of pagination
    */ 
    public function get()
    {
     ...
     */
    /**
    * @api {post} /comments/count  Get count: comments / pages / comments per page
    * @apiGroup Comments
    * @apiParam {string} gid  gid comments
    * @apiParam {int} id_obj  id object
    */     
     ...
     */
    /**
    * @api {post} /comments/getById  Get comment by id
    * @apiGroup Comments
    * @apiParam {int} id  id comment
    */  
     ...
     */
    /**
    * @api {post} /comments/delete  Delete comment
    * @apiGroup Comments
    * @apiParam {int} id  id comment
    */  
    ...
    * @apiGroup Comments
    * @apiParam {string} gid  gid comment
    * @apiParam {int} id_obj  id object
    ...
    */ 
     ...
     */
    /**
    * @api {post} /comments/types Get comments types
    * @apiGroup Comments
    * @apiParam {string} gid  gid comment
    */ 
