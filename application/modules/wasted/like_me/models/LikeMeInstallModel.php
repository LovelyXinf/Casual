...
class LikeMeInstallModel extends \Model
{
    ...
    protected $menu = array(
        ...
        'user_top_menu' => array(
            ...
            "action" => "none",
            "items"  => array(
                'like_me' => array("action" => "create", 'icon' => '',
    ...
    protected $_notifications = array(
        'notifications' => array(
            array('gid' => 'like_me_overlap', 'send_type' => 'que'),
        ),
        'templates' => array(
            array('gid' => 'like_me_overlap', 'name' => 'Like Me', 'vars' => array('user_nickname', 'profile_nickname', 'image', 'link_1', 'link_2'), 'content_type' => 'html'),
        ),
    );
    ...
    protected $moderators = array(
        array('module' => 'like_me', 'method' => 'index', 'is_default' => 1, 'group_id' => 7, 'is_hidden' => 0, 'parent_module' => '')
    );
    ...
    public function __construct()
    {
        ...
        $this->access_permissions = Setup::getModuleData(
                LikeMeModel::MODULE_GID, Setup::TYPE_ACCESS_PERMISSIONS
        );
    }
