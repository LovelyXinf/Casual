...
class Network extends \Controller
{
    ...
    public function register()
    {
        if ($this->input->post('btn_agree')) {
            ...
            $this->Network_users_model->userDeleted(array('id' => $this->user_id));
        ...
        } elseif (NetworkUsersModel::DECISION_UNKNOWN !== $this->Network_users_model->getUserDecision($this->user_id)) {
            // Already answered
