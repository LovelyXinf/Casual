...
$fe_fields = array(
	...
	array("data" => array( "gid" => "about_me", "section_gid" => "about-me", "editor_type_gid" => "users", "field_type" => "textarea", "fts" => "1", "settings_data" => 'a:3:{s:13:"default_value";s:0:"";s:8:"min_char";i:0;s:8:"max_char";i:0;}', "sorter" => "7", "options" => "")),
	array("data" => array( "gid" => "ideal_date", "section_gid" => "my-interests", "editor_type_gid" => "users", "field_type" => "textarea", "fts" => "1", "settings_data" => 'a:3:{s:13:"default_value";s:0:"";s:8:"min_char";i:0;s:8:"max_char";i:0;}', "sorter" => "1", "options" => "")),
	array("data" => array( "gid" => "best_bd", "section_gid" => "my-interests", "editor_type_gid" => "users", "field_type" => "textarea", "fts" => "1", "settings_data" => 'a:3:{s:13:"default_value";s:0:"";s:8:"min_char";i:0;s:8:"max_char";i:0;}', "sorter" => "2", "options" => "")),
...
$fe_forms = array(
	array("data" => array( "gid" => "advanced_search", "editor_type_gid" => "users", "name" => "Search form", "field_data" => '')),
	array("data" => array( "gid" => "perfect_match", "editor_type_gid" => "users", "name" => "Perfect match", "field_data" => '')),
);
