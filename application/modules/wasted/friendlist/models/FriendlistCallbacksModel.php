 ...
 */
class FriendlistCallbacksModel extends \Model
{
    ...
    public function addCallback($module, $model, $method, $event_status = '')
    {
        ...
        $this->ci->db->insert(FRIENDLIST_CALLBACKS_TABLE, $attrs);
    ...
    {
        $this->ci->db->where('module', $module)->delete(FRIENDLIST_CALLBACKS_TABLE);
    ...
    {
        $this->ci->db->where('id', $id)->delete(FRIENDLIST_CALLBACKS_TABLE);
    ...
    public function getCallbacks($event_status = '', $module = '')
    {
        ...
        return $this->ci->db->select($this->fields_str)->from(FRIENDLIST_CALLBACKS_TABLE)->get()->result_array();
    }
