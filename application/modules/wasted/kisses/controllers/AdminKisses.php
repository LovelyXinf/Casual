 ...
 * */
class AdminKisses extends \Controller
{
    /**
     * Constructor
     */
    ...
    {
        parent::__construct();
        $this->load->model(['Menu_model', 'Kisses_model', 'Uploads_model']);
     ...
     * return string
     */
    public function ajaxConfirmDeleteSelect()
    {
    ...
    public function ajaxDeleteSelect()
    {
        ...
        $this->deleteKisses($kisses_id, true);
    }
     ...
     *              return error or success
     */
    public function deleteKisses($kisses_id = null, $message = true)
    {
        if (!empty($kisses_id)) {
            $is_deleted = true;
    ...
    public function settings()
    {
        ...
        if ($this->input->post('btn_save')) {
            ...
            $data['items_per_page'] = $this->input->post('users_items_per_page', true);
