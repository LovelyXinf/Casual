 ...
 * */
class ApiWallEvents extends \Controller
{
    private $user_id;
    ...
    /**
    * @api {post} /wall_events/getEvents Get events
    * @apiGroup Wall events
    * @apiParam {int} [type] events type
    * @apiParam {int} [place] events place
    * @apiParam {int} [id_wall] user wall id
    * @apiParam {int} [max_id] from max event id 
    * @apiParam {int} [min_id] to min even id
    */
    public function getEvents()
    {
        ...
        $data = $this->getEventsInternal($post_data, $use_load, $items_on_page);
        $this->set_api_content('data', $data);
    }

    private function getEventsInternal($data, $use_load = false, $items_on_page = null, $page = null)
    {
        $result['status'] = 0;
    ...
    /**
    * @api {post} /wall_events/userPermissions User permissions
    * @apiGroup Wall events
    * @apiParam {string} [redirect_url] redirect url
    */
    ...
    /**
    * @api {post} /wall_events/saveUserPermissions Save user permissions
    * @apiGroup Wall events
    * @apiParam {string} [redirect_url] redirect url
    * @apiParam {array} perm permission data
    */
    ...
    /**
    * @api {post} /wall_events/post Post event
    * @apiGroup Wall events
    * @apiParam {string} [place] event place
    * @apiParam {int} id_wall user wall id
    * @apiParam {string} [text] event text
    */
    public function post()
    {
        ...
        $result = $this->postInternal($id_wall, $text, 0, array('text'));
        $this->set_api_content('data', $result);
    }

    /**
    * @api {post} /wall_events/postDelete Delete post
    * @apiGroup Wall events
    ...
    */
    ...
    /**
    * @api {post} /wall_events/postUpload Post upload
    * @apiGroup Wall events
    * @apiParam {int} id_wall user wall id
    * @apiParam {string} [place] event place
    * @apiParam {string} [text] event text
    ...
    */
    public function postUpload()
    {
        ...
        $result = $this->postInternal($id_wall, $text, $id);
        $this->set_api_content('data', $result);
    }


    private function postInternal($id_wall, $text = '', $id = 0, $required_fields = array())
    {
        $data['text'] = $text;
