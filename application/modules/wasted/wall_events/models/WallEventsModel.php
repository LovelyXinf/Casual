...
class WallEventsModel extends \Model
{
    ...
    private function saveEvent($attrs, $where = array())
    {
    ...
    {
        $result = $this->fetchEvents(['where' => ['id' => $id]]);
        if (!empty($result[0])) {
            return $result[0];
        }
    ...
    public function getEvents($params = array(), $items_on_page = null, $page = null)
    {
    ...
    public function formatWallEvents($events, $format_user = false, $safe_format = false)
    {
        ...
        if ($format_user) {
            ...
            if (!empty($users_ids)) {
                $users = $this->ci->Users_model->getUsersListByKey(null, null, null, array(), $users_ids, true);
            }
        }
     ...
     * @return array
     */
    public function getWallEvents($page = 1, $items_on_page = 20, $order_by = null, $params = array(), $filter_object_ids = null, $format_items = true, $format_owner = false, $format_user = false, $safe_format = false)
    {
        ...
        if ($format_user && !empty($result)) {
            ...
            $this->ci->load->model('Users_model');
            $users = $this->ci->Users_model->getUsersListByKey(null, null, null, array(), $users_ids, false);
    ...
    public function getWallEventsByKey($page = 1, $items_on_page = 20, $order_by = null, $params = array(), $filter_object_ids = null, $format_items = true, $format_owner = false, $format_user = false, $safe_format = false)
    {
