...
class MailListModel extends \Model
{
    ...
    public function __construct()
    {
        ...
        if ($this->ci->pg_module->is_module_installed('couples')) {
            $this->fields_user = \Pg\modules\couples\models\CouplesModel::addFields(USERS_TABLE, $this->fields_user);
        }
        // Add table name as prefixes
        array_walk($this->fields_user, function(&$item) { $item = USERS_TABLE . "." . $item;});
    }
