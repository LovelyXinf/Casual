...
class ServicesUsersModel extends \Model
{
    ...
    public function saveService($service_id = null, $attrs = array())
    {
    ...
    public function updateService($params, $attrs = array())
    {
    ...
    public function getServicesList($params = array(), $order_by = null, $filter_object_ids = null, $lang_id = '', $add_expire_data = true)
    {
        $data = array();
    ...
    public function availableServiceBlock($id_user, $template_gid)
    {
        ...
        if ($this->ci->agent->is_referral()) {
            $this->ci->session->set_userdata(array('service_redirect' => $this->ci->agent->referrer()));
        }
