...
class SpamInstallModel extends \Model
{
    ...
    protected $notifications = array(
        "templates" => array(
            array('module' => SpamModel::MODULE_GID, "gid" => "spam_object", "name" => "Spam object", "vars" => array("type", "poster", "object_id", "reason", "message"), "content_type" => "text"),
        ),
        "notifications" => array(
            array('module' => SpamModel::MODULE_GID, "gid" => "spam_object", "template" => "spam_object", "send_type" => "simple"),
        ),
    );
    ...
    protected $moderators = array(
        array("module" => "spam", "method" => "index", "is_default" => 1, 'group_id' => 1, 'is_hidden' => 0, 'parent_module' => '')
    );
