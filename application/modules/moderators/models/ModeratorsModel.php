...
class ModeratorsModel extends \Model
{
     ...
     * @return array
     */
    public function getUsersList($page = null, $items_on_page = null, $order_by = null, $params = array(), $filter_object_ids = null)
    {
     ...
     * @return integer
     */
    public function saveUser($user_id = null, $attrs = array())
    {
        if (is_null($user_id)) {
     ...
     * @return array
     */
    public function getModuleDependences($params = array())
    {
        $return = array();
     ...
     * @return array
     */
    public function setModuleDependences($permissions = array()) {
     ...
     * @return array
     */
    public function validateUser($user_id = null, $data = array())
    {
     ...
     * @return array
     */
    public function getMethods($params = array())
    {
        $return = array();
    ...
    public function getMethodGroups()
    {
        ...
        if (!empty($results) && is_array($results)) {
            foreach ($results as $r) {
                $return[$r['id']] = array('gid' => $r['gid'], 'name' => l('moderate_method_group_'.$r['gid'], 'moderators'));
            }
        }
        return $return;
    }
     ...
     * @return array
     */
    public function getMethodsByGroups($params = array())
    {
        $return = array();
        $method_groups = $this->getMethodGroups();
        foreach ($method_groups as $m_id => $m_data) {
            $return[$m_data['gid']]['main'] = array(
                    'id' => $m_id,
                    'name' => $m_data['name'],
                    'is_default' => '1'
            );
            $return[$m_data['gid']]['module'] = array(
                    'id' => $m_id,
     ...
     * @return array
     */
    public function getMethodsLangExport($params = array(), $langs_ids = array())
    {
     ...
     * @return integer
     */
    public function saveMethod($id = null, $attrs = array(), $langs = array())
    {
        if (empty($id)) {
