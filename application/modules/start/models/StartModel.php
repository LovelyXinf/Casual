...
class StartModel extends \Model
{
    ...
    public function dynamicBlockGetStatBlock()
    {
        $stat = array();
    ...
    public function dynamicBlockGetSearchForm()
    {
    ...
    public function __call($name, $args)
    {
        $methods = [
            ...
            '_dynamic_block_get_search_form' => 'dynamicBlockGetSearchForm',
            '_dynamic_block_get_stat_block' => 'dynamicBlockGetStatBlock',
