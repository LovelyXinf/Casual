...
class StartInstallModel extends \Model
{
    ...
    public function arbitraryLangExport($langs_ids = null)
    {
        ...
        return array("admin_home_page" => $admin_home_page_return, "arbitrary" => $arbitrary_return, "admin_instructions_page" => $admin_instructions_page_return);
    }
    ...
    public function addDemoContent()
    {
        ...
        $this->ci->load->model("start/models/Start_Copyright_model");        
        $validate_data = $this->ci->Start_Copyright_model->validateCopyright(array('lang_id' => $default_lang['id'], 'data' => $data));
