...
$install_settings["date_format_date_literal_short"] = "[day_with_zero] [month_short] [year_4]";
...
if (PRODUCT_NAME == 'social') {
    $install_settings["product_version_code"] = '4';
    $install_settings["product_version_name"] = '2018.4';
} else {
    $install_settings["product_version_code"] = '14';
    $install_settings["product_version_name"] = 'Nymph';
}
...
$install_settings['is_fist_opening'] = 1;
$install_settings['is_fist_opening_product_tours'] = 0;

$install_settings['captcha_type'] = 'default';
$install_settings['captcha'] = '';
