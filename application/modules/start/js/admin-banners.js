...
function storeBanners(optionArr) {
    ...
    this.properties = {
        banner_path: 'https://www.datingpro.com/banners_dating_free_package/',
    ...
    var _return_url = {
        custom: {
            all: 'https://www.pilotgroup.net/'
        },
        design: {
            all: 'https://www.pilotgroup.net/',
        },
        modules: {
            all: 'https://marketplace.datingpro.com/',
            ru: 'https://marketplace.datingsoftware.ru/'
        },
        packages: {
            all: 'https://marketplace.datingpro.com/information/pricing/'
        }
    };
