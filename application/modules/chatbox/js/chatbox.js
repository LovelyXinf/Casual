function Chatbox(optionArr) {
    ...
    this.initDialogActions = function () {
        ...
        $emojiEditor.off('keydown').keydown(function (e) {
            ...
            success: function (resp) {
                if (resp.errors) {
                    ...
                    if (resp.content) {
                        ...
                        history.pushState({'contact_id':contact_id}, null, site_url + 'chatbox/index/' + contact_id);
                        // history.pushState(null, null, contact_id);
    ...
    this.closeDialog = function () {
        ...
        history.pushState({}, null, site_url+'chatbox/index');
    }
