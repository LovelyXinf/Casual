...
class SearchCriteria extends \Model
{
    ...
    public function __construct()
    {
        ...
        $this->criteria = $this->ci->Users_model->getCommonCriteria($search_data['full_criteria']);
    }
    ...
    {
        $this->excludeUsers([$this->user_id]);
    }
    ...
    public function lessThan($field_name, $field_value) {
        $this->operations[] = ['operator' => '<', 'field' => $field_name, 'value' => $field_value];
    }
    ...
    public function notEqual($field_name, $field_value) {
        $this->operations[] = ['operator' => '!=', 'field' => $field_name, 'value' => $field_value];
    }
