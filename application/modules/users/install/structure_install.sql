...
CREATE TABLE IF NOT EXISTS `[prefix]groups` (
  ...
  `is_trial` tinyint(3) NOT NULL,
  `trial_period` mediumint(3) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `[prefix]users` (
  ...
  `user_logo_moderation` varchar(255) NOT NULL,
  `user_logo_postmoderation` varchar(255) NOT NULL,
  `user_logo_declined` varchar(255) NOT NULL,
  ...
  `checked_email` tinyint(3) NOT NULL DEFAULT '0',
  `last_checked_email_date` datetime NOT NULL,
  `valid_email` tinyint(3) NOT NULL DEFAULT '0',
  `changed_email` varchar(50) NOT NULL,
  `confirm_code_new_email` varchar(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `email` (`email`),
...
DROP TABLE IF EXISTS `[prefix]users_blocked_callbacks`;
CREATE TABLE IF NOT EXISTS `[prefix]users_blocked_callbacks` (
  `id` int(3) NOT NULL AUTO_INCREMENT,
  `module` varchar(50) NOT NULL,
  `model` varchar(50) NOT NULL,
  `callback` varchar(255) NOT NULL,
...
DROP TABLE IF EXISTS `[prefix]current_profile_viewers`;
CREATE TABLE `[prefix]current_profile_viewers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `viewer_id` int(11) NOT NULL,
  `expire_after_ts` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `[prefix]users_restore_password`;
CREATE TABLE IF NOT EXISTS `[prefix]users_restore_password` (
  `id` int(3) NOT NULL auto_increment,
  `id_user` int(3) NOT NULL,
