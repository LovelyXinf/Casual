...
class FileUploadsModel extends \Model
{
    ...
    public function getDataPath($config_gid, $postfix = '')
    {
        if (!empty($postfix)) {
            $postfix = $postfix . '/';
        }
    ...
    public function getDataUrl($config_gid, $postfix = '')
    {
        if (!empty($postfix)) {
            $postfix = $postfix . '/';
        }
    ...
    public function formatUpload($config_gid, $postfix, $file_name = '')
    {
        if (!empty($file_name)) {
            $config_data = $this->get_config($config_gid);
            $path = $this->get_media_path($config_gid, $postfix);
    ...
    public function deleteUpload($config_gid, $postfix, $file_name)
    {
        $config_data = $this->get_config($config_gid);
