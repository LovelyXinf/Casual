...
class ModerationTypeModel extends \Model
{
    ...
    public function saveType($type_id, $attrs, $langs = array())
    {
        ...
        if (!$type_id) {
            ...
            $insId = $this->ci->db->query('SELECT LAST_INSERT_ID() as last_id')->result();
    ...
    public function deleteType($type_id)
    {
        ...
        $this->ci->db->delete(MODERATION_TYPE_TABLE, array('id' => $type_id));
