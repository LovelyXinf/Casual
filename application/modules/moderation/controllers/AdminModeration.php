...
class AdminModeration extends \Controller
{
    ...
    {
        /* <custom_R> */
        $this->view->setRedirect(site_url('admin/moderation/settings'));
        /* </custom_R> */
    ...
    {   
        ...
        if (isset($obj['upload_gid'])) {
            ...
            if ($obj['upload_gid'] == 'gallery_video') {
                ...
                } else if (isset($obj['video_content']['embed']) && $obj['video_content']['embed']) {
                     $media_preview = $obj['video_content']['embed'];
                }
            } else if ($obj['upload_gid'] == 'gallery_image') {
                if (isset($obj['media']['mediafile']['thumbs']['big'])) {
                    $media_preview = '<img src="'. $obj['media']['mediafile']['thumbs']['big'] .'">';
                }   
            } else if ($obj['upload_gid'] == 'gallery_audio') {
                if (isset($obj['fname'])) {
