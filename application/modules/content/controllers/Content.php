...
class Content extends \Controller
{
    ...
    public function view($gid)
    {
        ...
        if ($page_data['id_seo_settings']) {
            ...
            $seo_settings['title'] = !empty($seo_settings['title']) ? $seo_settings['title'] : $seo_data['title'];
            $seo_settings['header'] = $seo_data['title'];
    ...
    public function quickPage()
    {
        ...
        if (!empty($gid)) {
           $result = $this->Content_model->getPageByGid($gid, $this->pg_language->current_lang_id);
           $this->view->assign(['data' => $result['content']]);
           $this->view->render();
        }
    }
