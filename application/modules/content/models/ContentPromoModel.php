...
class ContentPromoModel extends \Model
{
    ...
    {
        $this->ci->db->select('COUNT(*) AS cnt')->from(CONTENT_PROMO_TABLE)->where('id_lang', $id_lang);
     ...
     * @return string
     */
    public function dynamicBlockGetContentPromo($params = array(), $view = '')
    {
    ...
    {
        $methods = [
            '_dynamic_block_get_content_promo' => 'dynamicBlockGetContentPromo',
