...
class ContentInstallModel extends \Model
{
        ...
        'user_footer_menu' => array(
            ...
            'items'  => array(
                ...
                'footer-menu-about-item'  => array(
                    ...
                    'sorter' => 2,
                    'items'  => array(
                        'footer-menu-about-us-item' => array('action' => 'create', 'link' => 'content/view/about-us', 'status' => 1, 'sortet' => 1),
                    ),
                ),
    ...
    protected $moderators_methods = array(
        array('module' => 'content', 'method' => 'index', 'is_default' => 1, 'group_id' => 3, 'is_hidden' => 0, 'parent_module' => '')
    );
