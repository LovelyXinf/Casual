 ...
 */
class VideoUploadsYoutubeModel extends \Model
{
    private $settings;
    ...
    private function youtubeUploadVideo($file_name, $file_path, $file_data)
    {
    ...
    public function youtubeGetInfo($video_id)
    {
        $return = array("errors" => array(), "data" => array());
    ...
    public function processingMethod($file_name, $file_path, $file_data, $config)
    {
        return $this->youtube_upload_video($file_name, $file_path, $file_data);
    }

    public function imagesMethod($file_name, $file_path)
    {
    ...
    public function deleteMethod($video_id)
    {
        $return = array("errors" => array(), "data" => array());
        $yt_data = $this->youtube_auth();
        $yt = $yt_data['yt'];
    ...
    private function saveExtImage($file_path, $url)
    {
    ...
    public function getDefaultEmbed($id, $width = 480, $height = 360)
    {
