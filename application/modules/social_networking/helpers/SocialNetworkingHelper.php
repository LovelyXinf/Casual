...
namespace Pg\modules\social_networking\helpers {
    ...
    if (!function_exists('buildAuthArray')) {
        function buildAuthArray($baseurl, $key, $secret, $extra = array(), $method = 'GET', $algo = SocialNetworkingModel::OAUTH_ALGORITHM_RSA_SHA1)
        {
    ...
    if (!function_exists('getAuthHeader')) {
        function getAuthHeader($baseurl, $key, $secret, $extra = array(), $method = 'GET', $algo = SocialNetworkingModel::OAUTH_ALGORITHM_RSA_SHA1)
        {
...
namespace {
    ...
    if (!function_exists('build_auth_array')) {
        function build_auth_array($baseurl, $key, $secret, $extra = array(), $method = 'GET', $algo = SocialNetworkingModel::OAUTH_ALGORITHM_RSA_SHA1)
        {
    ...
    if (!function_exists('get_auth_header')) {
        function get_auth_header($baseurl, $key, $secret, $extra = array(), $method = 'GET', $algo = SocialNetworkingModel::OAUTH_ALGORITHM_RSA_SHA1)
        {
