...
class SocialNetworkingServicesModel extends \Model
{
    ...
    public function getServicesList($order_by = null, $params = array(), $filter_object_ids = null)
    {
        $data = array();
    ...
    public function validateService($data = array())
    {
    ...
    public function saveService($service_id = false, $data = array())
    {
