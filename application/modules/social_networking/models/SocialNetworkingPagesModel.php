...
class SocialNetworkingPagesModel extends \Model
{
    ...
    public function getPagesList($order_by = null, $params = array(), $filter_object_ids = null)
    {
        $data = array();
    ...
    public function validatePage($page_id = false, $data = array())
    {
    ...
    public function savePage($page_id = false, $data = array())
    {
        $data = (array) $data;
        if (is_null($page_id)) {
