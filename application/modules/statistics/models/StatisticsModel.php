...
class StatisticsModel extends \Model
{
    ...
    public function __construct()
    {
        ...
        // TODO: cache
        $this->ci->cache->registerService('statistics_systems', CacheManager::PROVIDER_REDIS);
    }
    ...
    private function getAllSystems()
    {
        ...
        if ($this->systems_all === null) {
            ...
            $this->systems_all = $this->ci->cache->get('statistics_systems', 'all', function () use ($fields, $table)
            {
                $ci = &get_instance();
     ...
     * @return array
     */
    protected function getStatisticsListInternal($page = null, $limits = null, $order_by = null, $params = array(), $lang_ids = null)
    {
        if (empty($lang_ids)) {
    ...
    protected function getSystemsListInternal($page = null, $limits = null, $order_by = null, $params = array(), $lang_ids = null)
    {
        if (empty($lang_ids)) {
            $lang_ids = array($this->ci->pg_language->current_lang_id);
        }
    ...
    public function saveSystem($system_id, $system_raw)
    {
        ...
        // TODO: cache
        $this->ci->cache->flush('statistics_systems');
