...
class CountriesModel extends \Model
{
    ...
    public function __construct()
    {
        ...
        // TODO: cache
        $this->ci->cache->registerService('countries', CacheManager::PROVIDER_REDIS);
        $this->ci->cache->registerService('regions', CacheManager::PROVIDER_REDIS);
        $this->ci->cache->registerService('cities', CacheManager::PROVIDER_REDIS);
     ...
     * @return array
     */
    public function getCacheRegions($country_code, $country_cache_data = array())
    {
        $expiried_period = $this->ci->pg_module->get_module_config('countries', 'countries_update_period');
    ...
    public function getAllCountries()
    {
        if ($this->countries_all === null) {
            ...
            $this->countries_all = $this->ci->cache->get('countries', 'all', function () use ($fields)
            {
                $ci = &get_instance();
     ...
     * @return array
     */
    public function getCountries($order_by = array(), $params = array(), $filter_object_ids = array(), $lang_id = false)
    {
    ...
    public function getCountriesByCode($filter_object_ids = array(), $lang_id = false)
    {
     ...
     * @return integer
     */
    public function getCountriesCount($params = array())
    {
    ...
    public function getAllRegions()
    {
        if ($this->regions_all === null) {
            ...
            $this->regions_all = $this->ci->cache->get('regions', 'all', function () use ($fields)
            {
                $ci = &get_instance();
     ...
     * @return array
     */
    public function getRegionsById($filter_object_ids = array(), $lang_id = false)
    {
        if (empty($filter_object_ids) || !is_array($filter_object_ids)) {
            return [];
        }
     ...
     * @return array
     */
    public function getRegionsByCode($country_code, $order_by = array(), $params = array(), $filter_object_ids = array())
    {
        $data = array();
     ...
     * @return integer
     */
    public function getCitiesCount($params = array(), $filter_object_ids = array())
    {
        /// return installed cities
     ...
     * @return array
     */
    public function getCitiesById($filter_object_ids = array(), $lang_id = false)
    {
        if (empty($filter_object_ids) || !is_array($filter_object_ids)) {
            return [];
        }
        ...
        // TODO: cache
        $results = $this->ci->cache->mget('cities', $filter_object_ids, $get_data_callback);
     ...
     * @return array
     */
    public function getCitiesByRadius($lat, $lon, $radius = 10, $radius_type = "km", $page = null, $items_on_page = null, $params = array(), $filter_object_ids = array())
    {
        $lang_id = $this->ci->pg_language->current_lang_id;
    ...
    public function getCity($city_id, $lang_id = false, $languages = [])
    {
        ...
        // TODO: cache
        $result = $this->ci->cache->get('cities', $city_id, function () use ($fields, $city_id)
        {
            $ci = &get_instance();
    ...
    public function installCities($country_code, $region_code, $languages = array())
    {
    ...
    public function saveCity($id_city, $data)
    {
        ...
        // TODO: cache
        $this->ci->cache->delete('cities', $id_city);
    ...
    public function setRegionPriority($id_region, $priority)
    {
        ...
        // TODO: cache
        $this->ci->cache->flash('regions', 'all');
    }
