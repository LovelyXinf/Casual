function loadingContent(optionArr) {
    ...
    this.create_load_block = function () {
        ...
        if (_self.properties.linkerObjID) {
            $("body").append('<div id="' + _self.properties.loadBlockBgID + '"></div><div id="' + _self.properties.loadBlockID + '" class="col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-3 col-lg-8 col-lg-offset-2"><div id="' + _self.properties.loadBlockID + '_content"></div></div>');
        } else {
            $("body").append('<div id="' + _self.properties.loadBlockBgID + '"><div id="' + _self.properties.loadBlockID + '" class="col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-3 col-lg-8 col-lg-offset-2"><div id="' + _self.properties.loadBlockID + '_content"></div></div></div>');
        }
