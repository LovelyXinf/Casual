...
$_theme["gid"] = "gentelella_operator";
$_theme["type"] = "operator";
$_theme["name"] = "Operator area theme";
$_theme["description"] = "Default operator template; PilotGroup";
...
$_theme["css"] = array(
    "custom" => array("file"=>"custom-[dir].css", "media"=>"screen"),
);
