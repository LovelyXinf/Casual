function loadingContent(optionArr) {
    ...
    this.create_load_block = function () {
        ...
        if (_self.properties.draggable) {
            $("#" + _self.properties.loadBlockID).draggable({
                handle: "h1"
            });
        }
    ...
    this.show_load_block = function (content, animate) {
        ...
        $("#" + _self.properties.loadBlockID + '_content').find('input.flat').iCheck({
        ...
        if (animate && height_old && height) {
            $("#" + _self.properties.loadBlockID + '_content').stop().css('height', height_old + 'px').animate({
                'height': height + 'px'
            }, 100, function () {
        ...
        if (_self.properties.showAfterImagesLoad) {
            ...
            $("#" + _self.properties.loadBlockID + '_main').css({
                'display': 'block'
            });
    ...
    this.position_close = function () {
        ...
        $("#" + _self.properties.closeBtnID + '_header').css({
            'top': padding + 'px'
        }).css(_self.properties.posPropertyRight, padding + 'px');
    }
