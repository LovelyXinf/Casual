...
/* pool.twig */
class __TwigTemplate_17299ef39e55899f5361355d0973e83104d59cfc4cf6986d7e1cb9d1797b0a9b extends \Twig\Template
{
...
<script>
    ...
    ";
        ...
        if (($context["allow_pool_delete"] ?? null)) {
            ...
            // line 214
            echo ($context["site_url"] ?? null);
            echo "admin/notifications/pool_delete/' + getCheckBoxes();
            return false;
        });
    ";
        }
...
";
        // line 221
        $this->loadTemplate("@app/footer.twig", "pool.twig", 221)->display($context);
    }
    ...
    {
        return new Source("", "pool.twig", "/home/ovmarketing01/domains/chatme.nu/private_html/application/modules/notifications/views/gentelella/pool.twig");
    }
}
