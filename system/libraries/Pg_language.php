...
class CI_Pg_language
{
    ...
    public function __construct()
    {
        ...
        // TODO: cache
        $this->ci->cache->registerService('langs', CacheManager::PROVIDER_REDIS);
    ...
    public function get_langs($order = 'id ASC')
    {
        ...
        $this->languages = $this->ci->cache->get('langs', 'all', function () use ($fields)
        {
            $ci = &get_instance();
    ...
    public function set_lang($lang_id = null, $data)
    {
        ...
        // TODO: clear cache
        $this->ci->cache->delete('langs', 'all');
