...
class CI_Email
{
    ...
    public $multipart        = "alternative";    // "mixed" (in the body) or "related" (separate)
        ...
        switch ($this->_get_content_type()) {
            ...
            case 'html' :
                ...
                if ($this->send_multipart === false) {
                    ...
                    $hdr .= "Content-Type: multipart/" . $this->multipart . "; boundary=\"" . $this->_alt_boundary . "\"" . $this->newline;
                    ...
                    $hdr .= $this->_get_alt_message() . $this->newline . $this->newline;
                    $hdr .= "--" . $this->_alt_boundary . $this->newline;
