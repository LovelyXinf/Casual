...
class lang_ds_driver
{
    ...
    public function __construct()
    {
        ...
        // TODO: cache
        $this->ci->cache->registerService('langs_ds', CacheManager::PROVIDER_REDIS);
    }
    ...
    public function get_module($module_gid, $lang_id)
    {
        ...
        $results_raw = $this->ci->cache->get('langs_ds', $module_gid, function () use ($fields, $module_gid)
        {
            $ci = &get_instance();
        ...
        foreach ($results_raw as $result_raw) {
            switch ($result_raw["type"]) {
                case "header": $results[$result_raw["gid"]]["header"] = $result_raw['value_' .  $lang_id]; break;
                case "option": $results[$result_raw["gid"]]["option"][$result_raw["option_gid"]] = $result_raw['value_' .  $lang_id]; break;
            }
        }
    ...
    public function set_module_reference($module_gid, $gid, $data, $lang_id)
    {
        ...
        $this->ci->cache->delete('langs_ds', $module_gid);
    }
