...
class Language_pages
{
    ...
    public function get_string($module_gid, $gid, $lang_id = '')
    {
        ...
        } elseif ($_ENV['LANG_GID_VISIBILITY']) {
            $return = $gid;
        } else {
            return false;
        }
    ...
    /**
     * Load strings (return_module alias)
     *
     */
    public function load($module_gid, $lang_id=null) {
        return $this->return_module($module_gid, $lang_id);
    }
