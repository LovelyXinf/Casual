...
class CI_Router
{
    ...
    /* <custom_R> */
    public $is_operator_class = false;
    /* </custom_R> */
    ...
    public function _validate_request($segments)
    {
        ...
        /* <custom_R> */
        if ($segments[0] == self::OPERATOR_MODE) {
            $segments = array_slice($segments, 1);
    ...
    public function fetch_class($check_for_admin_code = false)
    {
        ...
        /* <custom_R> */
        } elseif ($this->is_operator_class) {
            return 'operator_' . $this->class;
        /* </custom_R> */
        } else {
            return $this->class;
        }
    ...
    public function fetch_custom_class()
    {
        if (!empty($_ENV['CUSTOM_MODE'])) {
            $custom_mode = trim($_ENV['CUSTOM_MODE'], '_') . '_';
        } else {
            $custom_mode =  '';
        }

        if ($this->is_admin_class) {
            $custom_class = $custom_mode . 'Admin_' . $this->class;
        } elseif ($this->is_api_class) {
            $custom_class = $custom_mode . 'Api_' . $this->class;
        /* <custom_R> */
        } elseif ($this->is_operator_class) {
            return $custom_mode . 'Operator_' . $this->class;
        /* </custom_R> */
        } else {
            $custom_class = $custom_mode . '_' . $this->class;
        }
        return $this->ucfirstModule($custom_class);
    }
