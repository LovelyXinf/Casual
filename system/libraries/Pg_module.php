...
class CI_Pg_module
{
    ...
    public function __construct()
    {
        ...
        // TODO: cache
        $this->ci->cache->registerService('modules', CacheManager::PROVIDER_REDIS);
        $this->ci->cache->registerService('modules_config', CacheManager::PROVIDER_REDIS);
        $this->ci->cache->registerService('modules_methods', CacheManager::PROVIDER_REDIS);
    }
    ...
    public function get_modules($params = [])
    {
        ...
        //     $this->modules = $this->ci->cache->get('modules', 'all', $get_data_callback);
        // } else {
    ...
    public function set_module_install($data)
    {
        ...
        // TODO: cache - clear modules
        $this->ci->cache->flush('modules');
    ...
    public function get_module_all_config($module_gid)
    {
        ...
        $this->config[$module_gid] = $this->ci->cache->get('modules_config', $module_gid, function () use ($fields, $module_gid)
        {
            $ci = &get_instance();
    ...
    public function set_module_all_config($module_gid, $data)
    {
        ...
        // TODO: clear cache
        $this->ci->cache->delete('modules_config', $module_gid);
