...
class Template_Lite
{
    ...
    public $_cache_salt = 'hwwspjh{pvu6}pl~z6hktpu6ptn6ztpslz5npm';
        ...
        if ($this->_resource_type == 1) {
            ...
            if ($size > 0) {
                ...
                if (function_exists('ioncube_file_is_encoded') and ioncube_file_is_encoded() and preg_match("/footer\.tpl/", $file)) {
                    $str_find = base64_decode('JmNvcHk7Jm5ic3A7MjAwMC0yMDIxJm5ic3A7PGEgaHJlZj0iaHR0cDovL3d3dy5waWxvdGdyb3VwLm5ldCI+UGlsb3RHcm91cC5ORVQ8L2E+IFBvd2VyZWQgYnkgPGEgaHJlZj0iaHR0cDovL3d3dy5kYXRpbmdwcm8uY29tLyI+UEcgRGF0aW5nIFBybzwvYT4=');
